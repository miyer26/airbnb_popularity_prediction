...
Usage: preprocessing.py --train_data_path=<train_data_path> --test_data_path=<test_data_path> --results_path=<results_path> 
...
def main(train_data_path, test_data_path, results_path):
    ...
    with open(f"{results_path}/preprocessor.pickle", "wb") as f:
